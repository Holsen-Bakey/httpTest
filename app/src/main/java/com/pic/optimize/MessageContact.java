 ...
 */
@Keep
@Entity(nameInDb = "MessageContactBean")
public class MessageContact {
    ...
    @Generated(hash = 814302962)
    public MessageContact(String id, String my_user_id, String user_id,
            String avatar, String nickname, String status, String daren_type,
